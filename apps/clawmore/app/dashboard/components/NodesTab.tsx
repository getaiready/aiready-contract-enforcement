...
export default function NodesTab({ detectedRegion }: NodesTabProps) {
  return (
        ...
        <div className="bg-black/60 border border-cyber-blue/20 rounded-2xl p-8 relative overflow-hidden group hover:border-cyber-blue/50 transition-all shadow-xl">
          ...
          <div className="space-y-4 mb-8">
            <div className="flex justify-between text-[10px] font-mono border-b border-white/5 pb-2">
              ...
              <span className="text-cyber-blue font-bold">SYNCHRONIZED</span>
            </div>
            <div className="flex justify-between text-[10px] font-mono border-b border-white/5 pb-2">
              <span className="text-zinc-600 uppercase">Active Agents:</span>
              <span className="text-white">Reflector, Planner, Coder</span>
            </div>
            <div className="flex justify-between text-[10px] font-mono border-b border-white/5 pb-2">
              <span className="text-zinc-600 uppercase">Traffic Gate:</span>
